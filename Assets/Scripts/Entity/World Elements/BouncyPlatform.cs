...
public class BouncyPlatform : SimulationBehaviour {
    ...
    //---Private Variables
    private readonly List<BouncyContact> positions = new();
    ...
    public override void Render() {
        ...
        foreach (BouncyContact contact in positions) {
        ...
        for (int i = positions.Count - 1; i >= 0; i--) {
            BouncyContact contact = positions[i];
    ...
    private BouncyContact GetContact(Collider2D collider) {
        foreach (BouncyContact contact in positions) {
            if (contact.exit)
                continue;
    ...
    public class BouncyContact {
        public EntityMover mover;
        public BouncyPlatform platform;
        public float timer;
        public bool exit;
        ...
        public BouncyContact(BouncyPlatform platform, EntityMover mover, BoxCollider2D collider) {
